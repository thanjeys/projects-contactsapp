 ...
 */
 ...
 if($_POST) { 
    ...
    if(empty($errors)) {
        ...
        $sql = "SELECT COUNT(*) FROM contacts WHERE contact_no=$contact_no";
        ...
        if($count > 0) 
            ...
            // Sql for Saving data
            $sql = "INSERT INTO contacts(name, contact_no, email) VALUES('$name', '$contact_no', '$email')";
            if (mysqli_query($db_conn, $sql) === true) {
                $result =  "New Contact has been added successfully ";
